        ...
        <Container style={{  width: 320 }}>
          <RowBox style={{ width: "90%" }}>
            <View style={{ width: "60%" }}>
              ...
              <PrimaryText style={{ fontSize: 12 }}><View style={{position:'absolute',left:-18}}><Ionicons name="ios-wallet-outline" size={14} color="white" /></View>Amount Staked</PrimaryText>
            ...
            >
              <PrimaryText style={{ fontSize: 12 }}><View style={{position:'absolute',left:-12}}><FontAwesome5 name="calendar-alt" size={12} color="white" /></View>Time of Staking</PrimaryText>
