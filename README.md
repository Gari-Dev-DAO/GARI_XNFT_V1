...
In this screen video Nfts from [](https://nft.chingari.io/) are shown. User Can play and watch these short videos in the form of nfts to have fun. User Can filter out the videos based on their interest and language preference. Intially there be no any filter applied.
